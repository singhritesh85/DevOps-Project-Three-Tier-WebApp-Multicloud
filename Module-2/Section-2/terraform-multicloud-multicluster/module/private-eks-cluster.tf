...
#    name    = var.launch_template_name
  ...
  depends_on = [
    ...
    aws_route.gcp_subnet_primary_range_public_RT,
    aws_route.gcp_subnet_master_ip_range_public_RT,
    aws_route.gcp_subnet_secondary_range_pods_public_RT,
    aws_route.gcp_subnet_secondary_range_service_public_RT,
    aws_route.gcp_subnet_ip_public_range_subnet_public_RT,
    aws_route.azure_vnet_cidr_public_RT,
    aws_route.gcp_subnet_primary_range_private_RT_1,
    aws_route.gcp_subnet_master_ip_range_private_RT_1,
    aws_route.gcp_subnet_secondary_range_pods_private_RT_1,
    aws_route.gcp_subnet_secondary_range_service_private_RT_1,
    aws_route.gcp_subnet_ip_public_range_subnet_private_RT_1,
    aws_route.azure_vnet_cidr_private_RT_1,
    aws_route.gcp_subnet_primary_range_private_RT_2,
    aws_route.gcp_subnet_master_ip_range_private_RT_2,
    aws_route.gcp_subnet_secondary_range_pods_private_RT_2,
    aws_route.gcp_subnet_secondary_range_service_private_RT_2,
    aws_route.gcp_subnet_ip_public_range_subnet_private_RT_2,
    aws_route.azure_vnet_cidr_private_RT_2,
    aws_route.gcp_subnet_primary_range_private_RT_3,
    aws_route.gcp_subnet_master_ip_range_private_RT_3,
    aws_route.gcp_subnet_secondary_range_pods_private_RT_3,
    aws_route.gcp_subnet_secondary_range_service_private_RT_3,
    aws_route.gcp_subnet_ip_public_range_subnet_private_RT_3,
    aws_route.azure_vnet_cidr_private_RT_3
  ]
}
...
resource "aws_security_group_rule" "allow_azure_gcp_to_eks_api" {
  type                     = "ingress"
  from_port                = 443  # AKS API endpoint uses HTTPS
  to_port                  = 443
  protocol                 = "tcp"
  cidr_blocks              = ["10.10.0.0/20", "172.16.0.0/28", "172.17.0.0/16", "172.19.0.0/16", "10.20.0.0/20", "10.224.0.0/12"]
  security_group_id        = aws_eks_cluster.eksdemo.vpc_config[0].cluster_security_group_id
  description              = "Allow jump box (K8S Managemnt) to access EKS private endpoint"
}

resource "aws_security_group_rule" "istio_15443" {
  type              = "ingress"
  from_port         = 15443
  to_port           = 15443
  protocol          = "tcp"
...
resource "aws_security_group_rule" "istio_15012" {
  type              = "ingress"
  from_port         = 15012
  to_port           = 15012
  protocol          = "tcp"
...
resource "aws_security_group_rule" "istio_15017" {
  type              = "ingress"
  from_port         = 15017
  to_port           = 15017
  protocol          = "tcp"
