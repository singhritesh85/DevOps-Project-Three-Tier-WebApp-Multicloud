...
resource "azurerm_private_dns_resolver_forwarding_rule" "private_dns_resolver_forwarding_rule_rds" {
  name                      = "${var.prefix}-pdr-resolver-aws-rule-rds"
  dns_forwarding_ruleset_id = azurerm_private_dns_resolver_dns_forwarding_ruleset.private_dns_resolver_forwarding_ruleset.id
  domain_name               = "rds.amazonaws.com." ###  "."  ### For all domains  ###"dexter-mysql3.private.mysql.database.azure.com."
  enabled                   = true
...
resource "google_dns_managed_zone" "aws_rds_forwarding_zone" {
  name        = "${var.prefix}-aws-rds-private-zone"
  dns_name    = "rds.amazonaws.com."
  description = "Forwarding to AWS DNS"
  visibility  = "private"
  forwarding_config {
    dynamic "target_name_servers" {
